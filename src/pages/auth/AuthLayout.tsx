...
export default function AuthLayout({ children }: AuthLayoutProps) {
  ...
  // const handleLogin = () => {
  //   if (!email) {
  //     setError("input a proper email format");
                ...
                {/* <form action="" className="my-[40px]">
                  <div className="mb-[20px]">
                    ...
                    <input
                      ...
                      className="w-[400px] h-[52px] pl-[16px] rounded-[12px] border border-[#F4F4F44D] bg-transparent"
                    />
                  </div>
                  ...
                  <div className="flex justify-between text-sm items-center">
                    <label className="flex items-center  text-white gap-[5px] cursor-pointer">
                      <input
                        ...
                        checked={rememberMe}
                        className="accent-black rounded-full bg-transparent border border-[#F4F4F44D] w-[20px] h-[20px] cursor-pointer"
                      />
                      Remember me
                    </label>
