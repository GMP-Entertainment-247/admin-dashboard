...
export default function InvestorDetails () {
    ...
    const {data: tableData, loading: tableLoading} = useFetch<{data: IFan[]}>("/admin/list-fans")
        ...
        <div>
            ...
            <div className="mt-6">
                <Table
                    ...
                    searchPlaceHolder="Search any investments"
                    ...
                    rows={[
                        ...
                        {
                            header: "Project",
                            view: (item) => <span>ABC Media</span>,
                        },
                        {
                            header: "Amount",
                            view: (item) => <span>$5,000</span>,
                        },
                        {
                            header: "Status",
                            view: (item) => "Active",
                        ...
                        },
                        {
                            ...
                            view: (item) => (
                                ...
                                alt="edit"
                                className="w-6 ml-4"
                                onClick={() => navigate(`/investors/investment/${item.id}`)}
                                />
                            ),
                        },
                    ]}
