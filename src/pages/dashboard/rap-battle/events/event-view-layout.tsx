    ...
    return (
        <div className="bg-white p-5 rounded-2xl w-full max-w-full flex flex-col lg:flex-row gap-7 lg:gap-[30px]">
            <article className="lg:w-[56%]">
                ...
                <div className="mb-7 lg:mb-8 rounded-xl border border-[#E9E9E9] p-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-3 text-sm">
                        ...
                        <div>
                            ...
                            <p className="font-semibold text-[#1A1A1A]">{availableTickets || "---"}</p>
                        </div>
                        <div>
                            <p className="text-[#6B6B6B]">Event Start</p>
                            <p className="font-semibold text-[#1A1A1A]">
                                {formatDateMDY(eventStartDate)} • {formatTime12Hour(eventStartTime)}
                            </p>
                        </div>
                        <div>
                            ...
                            <p className="font-semibold text-[#1A1A1A]">
                                {eventEndDate
                                    ? `${formatDateMDY(eventEndDate)} • ${formatTime12Hour(eventEndTime)}`
                                    : "---"}
                            </p>
                        </div>
                        <div>
                            ...
                            <p className="font-semibold text-[#1A1A1A]">
                                {saleStartDate
                                    ? `${formatDateMDY(saleStartDate)} • ${formatTime12Hour(saleStartTime)}`
                                    : "---"}
                            </p>
                        </div>
                        <div>
                            ...
                            <p className="font-semibold text-[#1A1A1A]">
                                {saleEndDate
                                    ? `${formatDateMDY(saleEndDate)} • ${formatTime12Hour(saleEndTime)}`
                                    : "---"}
                            </p>
                        </div>
                        {link ? (
