        ...
        <div>
            ...
            >
                <div className="flex items-center flex-col max-w-[360px] text-center">
                    <p className="text-base font-semibold text-[#212121] mt-4">Next Stage</p>
                    <p className="text-sm text-[#595959]">Are you sure you want to move this contestant to the next stage?</p>
                </div>
            </Modal>
        </div>
    )
