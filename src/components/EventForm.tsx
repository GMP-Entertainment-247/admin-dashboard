...
const EventForm = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const derivedEventEndDate =
      (formData.get("event_end_date") as string) || "";
    const derivedEventEndTime =
      (formData.get("event_end_time") as string) || "";
    ...
    if (!String(derivedAvailableTickets).trim())
      missingFields.push("Available Tickets");
  ...
  return (
    <EventInnerLayout title={mode === "create" ? "Create Event" : "Edit Event"}>
